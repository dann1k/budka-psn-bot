...
- `/popular` — топ-3 игры по числу разных участников чата, которые в них играли.
...
- `/popular` сканирует played games всех привязанных аккаунтов, склеивает версии игры через PSN `concept.id` и считает одного Telegram-участника один раз, даже если игра есть на нескольких его PSN-аккаунтах.
